...
function Options(props){
	...
	<div>
       ...
       <svg viewBox = "0 0 1000 648">
            ...
            onClick={(e)=>props.onInteractive(3)} style={{opacity:props.path.opacity[3]}}/>
            <path d = "m 179.1934,364.11792 -11.84434,34.76887 28.65566,55.78302 13.37264,12.60849 -3.05661,86.73113 55.01887,
				...
				onClick={(e)=>props.onInteractive(4)} style={{opacity:props.path.opacity[4]}}/>
            <path d = "m 53.493295,248.69146 c 19.992444,56.19498 19.992444,56.73532 19.992444,56.73532 l 1.621009,
				...
				onClick={(e)=>props.onInteractive(5)} style={{opacity:props.path.opacity[5]}}/>
            <path d = "m 458.20519,156.83429 30.79917,-22.15379 29.7185,-7.56471 34.04119,17.8311 8.10504,79.96978 -23.23446,
				...
				onClick={(e)=>props.onInteractive(2)} style={{opacity:props.path.opacity[2]}}/>
           <path d = "m 556.00607,149.26958 9.72605,83.75213 -24.31513,-16.75042 -7.02438,18.37143 -10.26639,3.78235 1.62101,15.12942 28.63783,
				...
				onClick={(e)=>props.onInteractive(1)} style={{opacity:props.path.opacity[1]}}/>
            <path d = "m 806.18178,476.71339 0.54034,45.38825 54.57396,-11.8874 8.64539,14.58908 11.34706,4.32269 -0.54034,8.10505 17.29076,
