...
<div id="wrap" style={{display:props.display.wrap}}>
	<div id="blokHealh">
		...
		{{background:props.counts.lose<3?`url(${require('../assets/images/heartGreen.png')}) 50% 50% / 100% 100% no-repeat`:'transparent'}} 
		/>

		<div id="health_2"style=
		{{background:props.counts.lose<2?`url(${require('../assets/images/heartYellow.png')}) 50% 50% / 100% 100% no-repeat`:'transparent'}} 
		/>

		<div id="health_3"style=
		{{background:props.counts.lose===0?`url(${require('../assets/images/heartRed.png')}) 50% 50% / 100% 100% no-repeat`:'transparent'}} 
		/>
