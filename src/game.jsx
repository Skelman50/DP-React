...
<div id="wrap" style={{display:props.display.wrap}}>
	<div id="blokHealh">
		...
		{{background:props.counts.lose<3?`url(${require('../assets/images/heartRed.png')}) 50% 50% / 100% 100% no-repeat`:'transparent'}} 
		/>
		...
		{{background:props.counts.lose===0?`url(${require('../assets/images/heartGreen.png')}) 50% 50% / 100% 100% no-repeat`:'transparent'}}
		/>
